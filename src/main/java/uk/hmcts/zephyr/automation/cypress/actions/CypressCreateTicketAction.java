...
import uk.hmcts.zephyr.automation.cucumber.actions.CucumberAction;
...
public class CypressCreateTicketAction
    ...
    public CypressCreateTicketAction(String[] args) {
...
//        FileUtil.writeToFile(Config.reportPath, report);
    }
}
